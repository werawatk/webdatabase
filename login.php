...
<head>
  ...
  <title>ระบบการจัดการสิทธิ์ใช้งาน</title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="login.html" class="h1"><b>ระบบเข้าใช้งาน</b></a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">ระบบการจัดการสิทธิ์ผู้ใช้งาน</p>
      

      <form action="" method="post">
        <div class="input-group mb-3">
          <input type="text" name="user" class="form-control" placeholder="กรอกชื่อผู้ใช้งาน">
